	...
	if( cookies != null ) {
		for(int i = 0 ; i < cookies.length ; i++) {
			...
			switch(cookieName) {
			 	...
			 	case "ship_name" 			: order.setShipName(cookieValue);	break;
			 	case "ship_date" 			: order.setDate(cookieValue);		break;
			 	case "ship_country" 		: order.setCountry(cookieValue);	break;
			 	case "ship_zipCode" 		: order.setZipCode(cookieValue);	break;
			 	case "ship_addressName" 	: ship_addressName = cookieValue; order.setAddress(cookieValue); break;
			 	case "ship_phone" 			: order.setPhone(cookieValue);		break;
			}
		}
	}		
